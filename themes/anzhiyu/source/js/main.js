...
function _regeneratorRuntime() {
    ...
    function c(e, t, n, o) {
        var i, r, a, c, t = t && t.prototype instanceof p ? t : p, t = Object.create(t.prototype), o = new O(o || []);
        return s(t, "_invoke", {
            value: (i = e,
            r = n,
            a = o,
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function E() {
        var e, n, r, t, a, o, i, c, u, l, s, d, m, y, h, f, g = GLOBAL_CONFIG.highlight;
        g && (e = g.highlightCopy,
        n = g.highlightLang,
        r = g.highlightHeightLimit,
        g = g.plugin,
        t = GLOBAL_CONFIG_SITE.isHighlightShrink,
        a = e || n || void 0 !== t,
        o = "highlight.js" === g ? document.querySelectorAll("figure.highlight") : document.querySelectorAll('pre[class*="language-"]'),
        ...
        ,
        (i = "prismjs" === g) ? o.forEach(function(e) {
            var t;
    ...
    function I() {
        ...
        0)
          ...
          , f = document.getElementById("nav-totop")
          , g = document.getElementById("body-wrap")
          , p = document.getElementById("post-comment") || document.getElementById("footer");
        function v(e) {
            var t = g.clientHeight
            ...
            }(p || 90 < t) && 20 < e ? (f.classList.add("long"),
            h.textContent = "返回顶部") : (f.classList.remove("long"),
            h.textContent = t),
    ...
    var a = {
      ...
      , k = (document.getElementById("rightside").addEventListener("click", function(e) {
        ...
        var e = _asyncToGenerator(_regeneratorRuntime().mark(function e() {
            ...
            return _regeneratorRuntime().wrap(function(e) {
                for (; ; )
                    switch (e.prev = e.next) {
                    case 0:
                        if (t = document.querySelector(":root"),
                        n = null == (n = document.getElementById("post-top-bg")) ? void 0 : n.src) {
                            e.next = 9;
                            break
                        }
                        return t.style.setProperty("--anzhiyu-bar-background", "var(--anzhiyu-meta-theme-color)"),
                        requestAnimationFrame(function() {
                            anzhiyu.initThemeColor()
                        }),
                        document.documentElement.style.setProperty("--anzhiyu-main", getComputedStyle(document.documentElement).getPropertyValue("--anzhiyu-theme")),
                        ...
                        e.abrupt("return");
                    case 9:
                        GLOBAL_CONFIG.mainTone ? GLOBAL_CONFIG_SITE.postMainColor ? (i = GLOBAL_CONFIG_SITE.postMainColor,
                        "light" === d(i) && (i = s(l(i), -40)),
                        t.style.setProperty("--anzhiyu-bar-background", i),
                        requestAnimationFrame(function() {
                            anzhiyu.initThemeColor()
                        }),
                        GLOBAL_CONFIG.mainTone.cover_change && (document.documentElement.style.setProperty("--anzhiyu-main", i),
                        document.documentElement.style.setProperty("--anzhiyu-theme-op", getComputedStyle(document.documentElement).getPropertyValue("--anzhiyu-main") + "23"),
                        document.documentElement.style.setProperty("--anzhiyu-theme-op-deep", getComputedStyle(document.documentElement).getPropertyValue("--anzhiyu-main") + "dd")),
                        e.next = 75) : e.next = 18 : e.next = 75;
                        break;
                    case 18:
                        return o = "var(--anzhiyu-theme)",
                        i = "",
                        "cdn" == GLOBAL_CONFIG.mainTone.mode || "both" == GLOBAL_CONFIG.mainTone.mode ? i = n + "?imageAve" : "api" == GLOBAL_CONFIG.mainTone.mode && (i = GLOBAL_CONFIG.mainTone.api + n),
                        e.prev = 21,
                        e.next = 24,
                        fetch(i);
                    case 24:
                        if ((a = e.sent).ok && null != (r = a.headers.get("content-type")) && r.includes("application/json"))
                            return e.next = 28,
                            a.json();
                        e.next = 36;
                        break;
                    case 28:
                        r = e.sent,
                        a = "cdn" == GLOBAL_CONFIG.mainTone.mode || "both" == GLOBAL_CONFIG.mainTone.mode ? "#" + r.RGB.slice(2) : r.RGB,
                        "light" === d(a) && (a = s(l(a), -40)),
                        t.style.setProperty("--anzhiyu-bar-background", a),
                        requestAnimationFrame(function() {
                            anzhiyu.initThemeColor()
                        }),
                        GLOBAL_CONFIG.mainTone.cover_change && (document.documentElement.style.setProperty("--anzhiyu-main", a),
                        document.documentElement.style.setProperty("--anzhiyu-theme-op", getComputedStyle(document.documentElement).getPropertyValue("--anzhiyu-main") + "23"),
                        document.documentElement.style.setProperty("--anzhiyu-theme-op-deep", getComputedStyle(document.documentElement).getPropertyValue("--anzhiyu-main") + "dd")),
                        e.next = 67;
                        break;
                    case 36:
                        if ("both" == GLOBAL_CONFIG.mainTone.mode)
                            return e.prev = 37,
                            e.next = 40,
                            fetch(GLOBAL_CONFIG.mainTone.api + n);
                        e.next = 64;
                        break;
                    case 40:
                        if ((u = e.sent).ok && null != (c = u.headers.get("content-type")) && c.includes("application/json"))
                            return e.next = 44,
                            u.json();
                        e.next = 52;
                        break;
                    case 44:
                        c = e.sent,
                        u = c.RGB,
                        "light" === d(u) && (u = s(l(u), -40)),
                        t.style.setProperty("--anzhiyu-bar-background", u),
                        requestAnimationFrame(function() {
                            anzhiyu.initThemeColor()
                        }),
                        GLOBAL_CONFIG.mainTone.cover_change && (document.documentElement.style.setProperty("--anzhiyu-main", u),
                        document.documentElement.style.setProperty("--anzhiyu-theme-op", getComputedStyle(document.documentElement).getPropertyValue("--anzhiyu-main") + "23"),
                        document.documentElement.style.setProperty("--anzhiyu-theme-op-deep", getComputedStyle(document.documentElement).getPropertyValue("--anzhiyu-main") + "dd")),
                        e.next = 55;
                        break;
                    case 52:
                        t.style.setProperty("--anzhiyu-bar-background", o),
                        requestAnimationFrame(function() {
                            anzhiyu.initThemeColor()
                        }),
                        document.documentElement.style.setProperty("--anzhiyu-main", o);
                    case 55:
                        e.next = 62;
                        break;
                    case 57:
    ...
    if (window.refreshFn = function() {
        ...
        A("console", ".darkmode_switchbutton"),
        ...
        GLOBAL_CONFIG.relativeDate.post && C(document.querySelectorAll("#post-meta time"))) : ((GLOBAL_CONFIG.relativeDate.homepage || GLOBAL_CONFIG.relativeDate.simplehomepage) && C(document.querySelectorAll("#recent-posts time")),
            ...
            function p(i) {
                ...
                h = setTimeout(function() {
                    var e = 3 * i.target.clientHeight
                      ...
                      , o = (n + t > g.clientWidth && (n -= n + t - g.clientWidth + 10),
                    n < 0 && (n = 10),
                    i.y - i.offsetY);
                    f.style.height = e + "px",
                    f.style.width = t + "px",
                    ...
                    f.innerHTML = '<img src="'.concat(i.target.src, '">')
                }, 100))
            }
            function v(e) {
    ...
    A("menu-darkmode"),
    A("sidebar", ".darkmode_switchbutton"),
    ...
    void 0 !== GLOBAL_CONFIG.copyright && (f = GLOBAL_CONFIG.copyright,
    c = f.limitCount,
    u = f.languages,
    m = f.copy,
    y = f.copyrightEbable,
    document.body.addEventListener("copy", function(e) {
        var t, n;
        if (m && anzhiyu.snackbarShow(u.copySuccess),
        y)
            return e.preventDefault(),
    ...
    GLOBAL_CONFIG.navMusic && (h = setInterval(function() {
        navMusicEl && navMusicEl.querySelector("#nav-music meting-js").aplayer && (clearInterval(h),
    ...
    ,
    (f = window).removeEventListener("keydown", g),
    f.removeEventListener("keyup", p),
    f.addEventListener("keydown", g),
    f.addEventListener("keyup", p)),
    ...
    GLOBAL_CONFIG.greetingBox) {
        var v = GLOBAL_CONFIG.greetingBox.list
          , G = GLOBAL_CONFIG.greetingBox.default
        ...
        if (T) {
            T.appendChild(B);
            for (var S = (new Date).getHours(), x = G, F = 0; F < v.length; F++)
